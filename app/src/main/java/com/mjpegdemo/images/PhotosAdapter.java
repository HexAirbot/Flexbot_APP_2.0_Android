...
public class PhotosAdapter extends BaseAdapter
{
	...
	public View getView(final int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			convertView = mInflater.inflate(R.layout.hud_view_gallery_item_gridview_photos, null);
		...
		Bitmap bitmap = NativeImageLoader.getInstance().loadNativeImage(NativeImageLoader.LOAD_TYPE.IMAGE, path, mPoint, new NativeImageCallBack()
		{
