...
public class BleConnectinManager {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {  //连接成功
                ...
                if (delegate != null) {
                    ...
                    Log.e("BleConnectinManager", " 调用didDisconnect******");
                }
            } else if (BluetoothLeService.ACTION_GATT_SERVICES_DISCOVERED.equals(action)) //可以开始干活了
            {

                isConnected = true;
                // Toast.makeText(BleConnectinManager.this.context, "连接成功，现在可以开始干活了", Toast.LENGTH_SHORT).show();
        		...
        		*/
                ...
                if (delegate != null) {
                    ...
                    Log.i("BleConnectinManager", " 调用BleconnectinManager");
                }
            }
    ...
    public void setisConnected(boolean i) {
        isConnected = i;
    }
    ...
    private IntentFilter makeGattUpdateIntentFilter() {                        //动态注册
